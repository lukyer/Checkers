...
static const char qt_meta_stringdata_GUIPlayer[] = {
    "GUIPlayer\0\0player,target\0"
    "move(Players,Position)\0"
};
...
void GUIPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->move((*reinterpret_cast< Players(*)>(_a[1])),(*reinterpret_cast< Position(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject GUIPlayer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GUIPlayer,
